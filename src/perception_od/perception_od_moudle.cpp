...
int32_t PerceptionOdMoudle::Init() { return 0; }

int32_t PerceptionOdMoudle::Start() { return hobot::dataflow::Module::Start(); }

int32_t PerceptionOdMoudle::Stop() { return hobot::dataflow::Module::Stop(); }
...
void PerceptionOdMoudle::TimerProc(hobot::dataflow::spMsgResourceProc proc,
  ...
  // pub ObstaclesMsg
  {
    ...
    obstacles_msg->proto.add_cylindricalobstalces()->CopyFrom(
        od_obstacleCylindrical);
