  ...
  namespace parking
  {
    ...
    void ParkingslotDetectMoudle::InitPortsAndProcs()
    {
      ...
      DF_MODULE_REGISTER_HANDLE_MSGS_PROC(
          ...
          DF_VECTOR(),
          DF_VECTOR("pub_apa_ps_rect", "pub_apa_ps_info", "pub_apa_pointI", "pub_psd_image", "pub_apa_ps_info_s32g", "pub_quad_parking_slots_s32g"));
    }
        ...
        const hobot::dataflow::MessageLists &msgs)
    {
      ...
      // pub_quad_parking_slots_s32g
      {
        ...
        quad_parking_slots_msg->proto.add_quadparkingslotlist()->CopyFrom(rd_quad_parking_slot);

        // pub msg
        auto pub_quad_parking_slots_s32g = proc->GetOutputPort("pub_quad_parking_slots_s32g");
